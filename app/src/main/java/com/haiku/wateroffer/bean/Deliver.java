...
public class Deliver implements Serializable {
    ...
    private int diliveryman_status;// 配送员状态(0：为未添加和删除状态，1：为暂停状态，2：为继续状态)
    ...
    public int getDiliveryman_status() {
        return diliveryman_status;
    }

    public void setDiliveryman_status(int diliveryman_status) {
