...
public class GoodsModelImpl extends BaseModelImpl implements IGoodsModel {
    ...
    public void getGoodsList(Map<String, Object> params, @NonNull final GoodsListCallback callback) {
        XUtils.Post(UrlConstant.Goods.listUrl(), ParamUtils.Goods.getListParams(params), new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                List<Goods> list = new ArrayList<>();
                if (!result.getRetmsg().isJsonNull()) {
                    list = GsonUtils.gsonToList(result.toMsgString(), Goods.class);
                }
    ...
    public void deleteGoods(Map<String, Object> params, @NonNull final GoodsListCallback callback) {
        XUtils.Get(UrlConstant.Goods.deleteUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.onSuccess();
            }
    ...
    public void offShelfGoods(Map<String, Object> params, @NonNull final IRequestCallback callback) {
        XUtils.Get(UrlConstant.Goods.offShelfUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.onSuccess();
            }
    ...
    public void upShelfGoods(Map<String, Object> params, @NonNull final IRequestCallback callback) {
        XUtils.Get(UrlConstant.Goods.upShelfUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.onSuccess();
            }
    ...
    public void uploadGoodsImage(Map<String, Object> params, @NonNull final IGoodsEditCallback callback) {
        ...
        x.http().post(requestParams, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
    ...
    public void getGoodsCategory(Map<String, Object> params, @NonNull final IGoodsEditCallback callback) {
        XUtils.Get(UrlConstant.Goods.getCategoryUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                List<GoodsCategory> list = new ArrayList<>();
                if (!result.getRetmsg().isJsonNull()) {
                    list = GsonUtils.gsonToList(result.toMsgString(), GoodsCategory.class);
                }
    ...
    public void addGoods(Map<String, Object> params, @NonNull final IGoodsEditCallback callback) {
        XUtils.Post(UrlConstant.Goods.addGoodsUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.onSuccess();
            }
    ...
    public void modifyGoods(Map<String, Object> params, @NonNull final IGoodsEditCallback callback) {
        XUtils.Post(UrlConstant.Goods.modifyGoodsUrl(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.updateInfoSuccess(GsonUtils.gsonToBean(result.toMsgString(), Goods.class));
            }
        });
    }
    ...
    public void getGoodsInfo(Map<String, Object> params, @NonNull final IGoodsEditCallback callback) {
        XUtils.Get(UrlConstant.Goods.getGoodsInfo(), params, new MyXUtilsCallback(callback) {
            @Override
            protected void onSuccessCallback(ResultData result) {
                callback.getGoodsInfoSuccess(GsonUtils.gsonToBean(result.toMsgString(), Goods.class));
            }
        });
    }
}
